...
- Done:
  ...
  - Added a `RunbookNarrator` port with a guarded narration seam: prose may be rewritten, but the original verified hypotheses and statuses are preserved even if a narrator overreaches.
